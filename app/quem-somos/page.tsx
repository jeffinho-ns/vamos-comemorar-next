        ...
        <div className="relative h-[400px] bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center">
          ...
          <div className="relative z-10 text-center text-white px-4">
            ...
            <p className="text-xl text-gray-200 max-w-2xl mx-auto">
              Conheça a equipe por trás do Agilizaí App e nossa jornada para
              revolucionar o agendamento de comemorações
            </p>
          </div>
        </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <p className="text-gray-600 leading-relaxed mb-4">
                    O Agilizaí App nasceu da necessidade de simplificar e
                    modernizar o processo de agendamento de comemorações em
                    bares e restaurantes. Fundada em 2024, nossa plataforma
                    surgiu da visão de conectar pessoas aos melhores
                    estabelecimentos da cidade de forma rápida e eficiente.
                  </p>
                  <p className="text-gray-600 leading-relaxed mb-4">
                    Começamos como uma pequena startup em São Paulo, com a
                    missão de transformar a experiência de reservas online.
                    Hoje, somos referência no setor, conectando milhares de
                    usuários aos estabelecimentos mais renomados da cidade.
                  </p>
                  <p className="text-gray-600 leading-relaxed">
                    Nossa equipe é composta por profissionais apaixonados por
                    tecnologia e inovação, sempre buscando oferecer a melhor
          ...
          <div className="max-w-6xl mx-auto mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-gray-600">
                  Oferecemos suporte excepcional aos nossos usuários e
                  parceiros, sempre prontos para ajudar.
                </p>
              </div>
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Visionário e empreendedor, lidera nossa missão de
                    revolucionar o mercado de reservas online.
                  </p>
                </div>
